package com.mukund.structure.filter;
...
import com.mukund.structure.controller.UserSessionController;
...
public class IsLogedInFilter implements Filter {
    ...
    String loginPage = "/pages/loginPage.xhtml";
    String homePage = "/pages/dashboard.xhtml";
